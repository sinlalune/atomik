...
title: CP-OPS-002 closing acceptance — Cairn 2.0, third candidate
...
accepted_at: 2026-09-02T10:56:30Z
decision: accepted
...
advisories_at_candidate: [concept-growth, transition, acceptance, single-truth]
supersedes: 2026-09-02-cp-ops-002-closing-2.md
...
# CP-OPS-002 — closing acceptance, third candidate

Supersedes the acceptance of `041c713a9328cbe6bc8948e399545057fc7a4d41`, which
stays as a true statement about a commit no longer proposed: its integration
pull request compared the branch with the trunk and found twenty-six immutable
session records edited at S00, and the restoration (S09e) moved the
implementation. The first acceptance, of `e409e85`, was voided by S09d.

## Result reviewed

- Candidate: `1f4ba09924860bea1de181400c4eba577980429f`
...
- Delivered outcome: the three false-certifying checks repaired and every predicate since made honest (S00–S08n); the protocol separated from its host and made executable (S08o–S08s); `cairn-init` and the adversarial fixture suite (S08u–S08w); the greenfield pilot run twice to `done` (S09a); the manifesto round and the owner's twenty-four rulings (S09b–S09c); the checker's host-variable proxy repaired after CI was read at closure (S09d); twenty-six immutable records restored and the workflow's comparison ref aligned with the laptop's after the first pull request (S09e)
- Definition-of-done evidence: `cairn-check` OK on the candidate with the thirteen steady advisories; `cairn-check:test` 277 subtests, locally and under CI's own variables, and the CI run on the candidate green; a repository created by `cairn-init` reaches `done` with zero red gates; coherence audit `cp-ops-002-1f4ba09…` filled
...
Four rules fired at the candidate, twelve lines in all; the `scope-drift` line of the first candidate is gone because the owner's root notes now live in the owner's checkout. Nine of the thirteen
