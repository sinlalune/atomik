...
|---|---|---|---|
| M0–M2 | shell · vault · AI patch loop | CP-MVP-001 | active |
| M3 | capture sources + local speech baseline | CP-MVP-002 | reserved |
| M4 | PDF source + strong anchors | CP-MVP-003 | reserved |
