...
- **None** — CP-MVP-008 closed 2026-08-04; the closing ceremony ran the same day (session note: `../sessions/2026-08-04-cp-mvp-008-closing-ceremony.md`). The next path activates only through its opening check (22 §Between paths); recorded inputs live in the [register](./index.md).
