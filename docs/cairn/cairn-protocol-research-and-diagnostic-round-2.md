...
**Reference Brief:** [`docs/cairn/cairn.md`](../cairn/cairn.md) · **Audit Record:** [`docs/cairn/cairn-audit-2026-08-24.md`](../cairn/cairn-audit-2026-08-24.md)
...
Cairn emerged before integrated `/brainstorm` primitives by distilling thinking into persistent Markdown files ([`docs/bedrock/`](../bedrock/00_00-orientation.md)) and static indices. By anchoring decisions and contracts in text, execution was decoupled from session longevity.
...
* **The Conceptual Model is Tri-Plane ([`docs/bedrock/35_35-coding-path-execution-state.md`](../bedrock/35_35-coding-path-execution-state.md)):**
...
* **The Repository Layout is Dual-Plane ([`docs/adr/ADR-009-coding-paths-work-ledger-dual-plane.md`](../adr/ADR-009-coding-paths-work-ledger-dual-plane.md)):**
...
During **CP-OPS-001** ([`docs/adr/ADR-012-parallel-paths-self-merge.md`](../adr/ADR-012-parallel-paths-self-merge.md)), Cairn evolved through owner challenge:
