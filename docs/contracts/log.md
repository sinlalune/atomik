...
title: Log — docs/contracts
description: Recent meaningful changes to machine-readable contract mirrors, per the OKF folder convention.
tags: [log, okf, contracts]
timestamp: 2026-08-24T00:00:00Z
---

# Log — `docs/contracts`

Recent meaningful changes in this scope: machine-readable contract mirrors. The companion map is
